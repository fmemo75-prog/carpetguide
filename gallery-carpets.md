---
layout: default
title: Carpet & Weaving Collection
---
...
# 🧶 The Art of the Loom: Carpet Collection
**Curated by Fatih Mehmet Canıtez**

This collection features masterworks of Anatolian weaving, from silk masterpieces to nomadic tribal rugs.

<div class="gallery-grid">
  {% assign all_files = site.static_files | sort: "path" %}
  {% for file in all_files %}
    <!-- SADECE ADI 'hali-' İLE BAŞLAYANLARI FİLTRELE -->
    {% if file.path contains '/images/hali-' %}
        ...
        <div class="gallery-item">
          <a href="{{ site.baseurl }}{{ file.path }}" target="_blank" class="gallery-link">
            <img src="{{ site.baseurl }}{{ file.path }}" class="gallery-img" alt="Carpet Masterpiece" loading="lazy">
          </a>
          <div class="gallery-info">
            {{ custom_caption | default: "🔍 Hand-knotted Masterpiece <br> Click to enlarge" }}
          </div>
        </div>
