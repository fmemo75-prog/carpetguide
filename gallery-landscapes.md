---
layout: default
title: Cappadocia Landscapes Gallery
---
...
**Photography by Fatih Mehmet Canıtez**

A personal collection of the unique valleys, fairy chimneys, and magical sunrises of Cappadocia.

<div class="gallery-grid">
  {% assign all_files = site.static_files | sort: "path" %}
  {% for file in all_files %}
    <!-- SADECE ADI 'vadi-' İLE BAŞLAYANLARI FİLTRELE -->
    {% if file.path contains '/images/vadi-' %}
        ...
        <div class="gallery-item">
          <a href="{{ site.baseurl }}{{ file.path }}" target="_blank" class="gallery-link">
            <img src="{{ site.baseurl }}{{ file.path }}" class="gallery-img" alt="Cappadocia Landscape" loading="lazy">
          </a>
          <div class="gallery-info">
            {{ custom_caption | default: "🌄 Magical Cappadocia <br> Click to enlarge" }}
          </div>
        </div>
