...
Welcome to the open-source encyclopedia of weaving arts. Please select your language to start exploring:

## 🌐 Select Language / Dil Seçin
- 🇬🇧 **[English Guide (Primary)](./en/)** - *Comprehensive guide to types, history, and care.*
- 🇹🇷 [Türkçe Rehber (Yakında)](./tr/)
- 🇫🇷 [Guide Français (Bientôt)](./fr/)

---

## 🚀 Quick Start (English)
If you are looking for specific information, jump directly to:
