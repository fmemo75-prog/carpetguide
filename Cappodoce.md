...
<head>
    ...
    <title>Cappadocia Travel Guide | Göreme Center</title>
    ...
    <style>
        ...
        header {
            background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('https://images.unsplash.com/photo-1541123356219-284ebe98ae3b?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80');
        ...
        .card i { margin-right: 10px; color: var(--secondary-color); }
...
<header>
    ...
    <p>The Ultimate Guide Centered in Göreme</p>
</header>

<div class="container">
    
    <!-- Distance Section -->
    <h2 class="section-title">Distances from Göreme Center</h2>
        ...
        <table>
            <thead>
                <tr>
                    <th>Destination</th>
                    <th>Distance</th>
                    <th>Travel Time (Car)</th>
                    <th>Must-See Feature</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td>Göreme Open Air Museum</td>
                    <td>1.5 km</td>
                    <td>3 mins</td>
                    <td>Ancient Cave Churches</td>
                </tr>
                <tr>
                    <td>Uçhisar Castle</td>
                    <td>5 km</td>
                    <td>10 mins</td>
                    <td>Panoramic Sunset View</td>
                </tr>
                <tr>
                    <td>Pasabağ (Monks Valley)</td>
                    <td>6 km</td>
                    <td>10 mins</td>
                    <td>Fairy Chimneys</td>
                </tr>
                <tr>
                    <td>Derinkuyu Underground City</td>
                    <td>35 km</td>
                    <td>40 mins</td>
                    <td>Deepest Ancient City</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <!-- Transport Section -->
    <h2 class="section-title">Transportation & Rentals</h2>
    <div class="grid">
        <div class="card">
            <h3><i class="fas fa-car"></i> Car Rental</h3>
            <p>Best for Ihlara Valley and Underground Cities. Average price: €40-60 per day.</p>
        </div>
        <div class="card">
            <h3><i class="fas fa-motorcycle"></i> Moto & Scooter</h3>
            <p>Perfect for valley hopping. License required. Approx €35 per day.</p>
        </div>
        <div class="card">
            <h3><i class="fas fa-bicycle"></i> E-Bike</h3>
            <p>Eco-friendly way to see Love Valley and Sword Valley. Hilly terrain!</p>
        </div>
    </div>

    <!-- Valleys & Hiking -->
    <h2 class="section-title">Hiking & Valleys</h2>
    <div class="grid">
        <div class="card">
            <h3>Rose & Red Valley <span class="badge">Top Pick</span></h3>
            <p>The best hiking trail for sunset. The rocks turn vibrant red as the sun goes down.</p>
        </div>
        <div class="card">
            <h3>Pigeon Valley</h3>
            <p>A 4km easy trail connecting Uçhisar to Göreme. Look for the ancient pigeon houses.</p>
        </div>
        <div class="card">
            <h3>Love Valley</h3>
            <p>Famous for its unique tall rock formations. Great for morning balloon watching.</p>
        </div>
    </div>

    <!-- Recommendations -->
    <h2 class="section-title">Top Rated (Google 4.5+)</h2>
    <div class="grid">
        <div class="card">
            <h3><i class="fas fa-utensils"></i> Dining</h3>
            <ul>
                <li><strong>Topdeck Cave:</strong> Authentic mezes.</li>
                <li><strong>Dibek:</strong> Traditional Pottery Kebab.</li>
                <li><strong>Seten:</strong> Fine dining with a view.</li>
            </ul>
        </div>
        <div class="card">
            <h3><i class="fas fa-bed"></i> Stay</h3>
            <ul>
                <li><strong>Museum Hotel:</strong> Luxury & History.</li>
                <li><strong>Sultan Cave Suites:</strong> Iconic rooftop.</li>
                <li><strong>Kelebek Cave:</strong> Boutique experience.</li>
            </ul>
        </div>
        <div class="card">
            <h3><i class="fas fa-spa"></i> Wellness & Fun</h3>
            <ul>
                <li><strong>Kelebek Hamam:</strong> Best Turkish Bath.</li>
                <li><strong>ATV Safari:</strong> Sunset adventure.</li>
                <li><strong>Horseback Riding:</strong> Real "Land of Horses".</li>
            </ul>
        </div>
    </div>

    <!-- Must See -->
    <h2 class="section-title">Don't Leave Without Seeing</h2>
    <div class="card" style="text-align: center;">
        <p><strong>The Dark Church (Karanlık Kilise):</strong> Located inside Göreme Open Air Museum, it houses the best-preserved frescoes in the world. The colors are still as vivid as they were 1000 years ago!</p>
    </div>

</div>

<footer>
    <p>&copy; 2024 Cappadocia Travel Guide - Prepared for your next adventure.</p>
</footer>
